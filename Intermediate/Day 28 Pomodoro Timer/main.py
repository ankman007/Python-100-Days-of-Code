...
# Buttons
start_button = Button(text='Start', border=1, bg='white', highlightthickness=0, command=start_timer)
start_button.grid(column=1, row=3)

reset_button = Button(text='Reset', border=1, bg='white', highlightthickness=0, command=reset_timer)
